...
const data = Array(10).fill('').map((e, i) => ({ id: i + 1, photo: p2.src, title: 'Female classic T-shirt with custom image dog, cat, tiger, ...', description: 'Apply badge to products with discount' }))
      ...
      <div className='overflow-auto mt-4'>
        {data?.map((e, i) => (
          <div key={i} className='flex flex-row rounded-md border mt-2 p-4'>
            ...
            <div>
              <div className='text-lg text-pr text-three-lines'>{e.title}</div>
